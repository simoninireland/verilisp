...
;;; Some functions to cheack the legality of identifiers. Common Lisp is much
;;; more forgiving of these than Verilog, and there are some sanity checks
;;; needed to make sure things synthesise properly.
;;;
;;; An alternative would be to rename variales uniquely, but that would render
;;; the resulting Verilog entirely unreadable. So instead we stay as close
;;; to the Lisp syntax and identifier choices as possible.
